...
public class AdapterMusicIKhareji extends RecyclerView.Adapter<AdapterMusicIKhareji.ViewHolder> {


    public static List<StructMusicKhareji> items;

    public AdapterMusicIKhareji(List<StructMusicKhareji> items) {
        this.items = items;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        StructMusicKhareji item = items.get(position);
