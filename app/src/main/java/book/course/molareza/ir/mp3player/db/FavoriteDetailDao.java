...
/** 
 * DAO for table "FAVORITE_DETAIL".
*/
public class FavoriteDetailDao extends AbstractDao<FavoriteDetail, Long> {

    public static final String TABLENAME = "FAVORITE_DETAIL";

    /**
     * Properties of entity FavoriteDetail.<br/>
    ...
    */
    ...
    public FavoriteDetailDao(DaoConfig config) {
        super(config);
    }
    
    public FavoriteDetailDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FAVORITE_DETAIL\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FAVORITE_DETAIL\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, FavoriteDetail entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public FavoriteDetail readEntity(Cursor cursor, int offset) {
        FavoriteDetail entity = new FavoriteDetail( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, FavoriteDetail entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(FavoriteDetail entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(FavoriteDetail entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
