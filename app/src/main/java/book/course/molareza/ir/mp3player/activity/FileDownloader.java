...
public class FileDownloader extends AsyncTask<String, Integer, String> {
    ...
    protected void onPostExecute(String s) {
        ...
        Log.i("TAGTAGTAG", "t7676t76t: "  + G.DIR_CLIP);
        if (s != null) {

            Toast.makeText(G.context, "خطا در حین دانلود", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(G.context, "دانلود با موفقیت صورت گرفت", Toast.LENGTH_SHORT).show();
