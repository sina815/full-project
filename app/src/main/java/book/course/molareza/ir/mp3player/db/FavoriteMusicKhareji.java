...
/**
 * Entity mapped to table "FAVORITE_MUSIC_KHAREJI".
 */
public class FavoriteMusicKhareji {
    ...
    public FavoriteMusicKhareji() {
    }

    public FavoriteMusicKhareji(Long id) {
        this.id = id;
    }

    public FavoriteMusicKhareji(Long id, String name, String id_item, String album, String thImage, String bigImage, String mp3_64, String mp3_128, String table) {
        this.id = id;
        this.name = name;
